            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3 class="d-block w-100">{{ __('Inventory Reports')}}

                            <small class="float-right">
                                <a title="Back Button" href="{{ URL::previous() }}" class="badge badge-secondary">
...
<script>
    ...
    var dTable = $('#data_table').DataTable({
        ...
        columns: [
            ...
            {data: 'stockIn', name: 'stockIn', searchable: false},
            {data: 'stockOut', name: 'stockOut', searchable: false},
            {data: 'currentStock', name: 'currentStock', searchable: false},
        ],
    ...
    $('#search').on('click',function(event){
            ...
            var dTable = $('.table').DataTable({
                ...
                pagingType: "full_numbers",
                ajax: {
                    url: "{{ route('monthly-inventory-report') }}",
                    type: "GET",
                    data:{
